...
class CalendarEvent {
  constructor(data) {
    ...
    this.humanRecurrenceRule = data.humanRecurrenceRule;
  ...
  equals(item, ignoreUUID = false) {
    ...
    return this._masterUUID === item._masterUUID &&
      ...
      this.humanRecurrenceRule === item.humanRecurrenceRule &&
  ...
  toSQL() {
    return {
      ...
      humanRecurrenceRule: this.humanRecurrenceRule,
...
CalendarEvent.validate = data => {
  ...
  try {
    ...
    if (data.isRecurring) {
      data.humanRecurrenceRule = UTIL.validateString(data.humanRecurrenceRule, 'humanRecurrenceRule');
    ...
    } else { data._recurrenceRule = data._noMore = data.humanRecurrenceRule = null; }
  } catch (e) {
